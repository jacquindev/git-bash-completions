...
__hugo_handle_standard_completion_case() {
    ...
    if ((${#COMPREPLY[*]} == 1)); then
        ...
        __hugo_debug "Removed description from single completion, which is now: ${COMPREPLY[0]}"
    else
